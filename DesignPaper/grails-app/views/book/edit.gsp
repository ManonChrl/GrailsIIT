	...
	<body>
		...
		<div id="list-course" class="content scaffold-list" role="main">
			...
			<g:if test="${session.role=='manager'}">
				<g:form controller="book" action="doEdit" class="form-horizontal" role="form" >
					<div class="form-group">
						<label for="librarySection" class="col-sm-2 control-label">Library Section : </label>	
						<div class="col-xs-3">
							<g:textField name="librarySection" value="${book.librarySection }" class="form-control"/>
						</div>
					</div>
					<div class="form-group">
					...
					<g:hiddenField type="number" name="barcode" value="${book.barcode }" class="form-control"/>
					<div class="form-group">
